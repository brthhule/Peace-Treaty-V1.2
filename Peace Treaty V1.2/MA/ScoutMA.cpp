...
int ScoutMA::selectUnitToScout(std::string &unitName, bool &isProvince, std::pair<int, int> &coordinates) {
	int unitLevel = 0;
	std::cout << "\033[;34m";
